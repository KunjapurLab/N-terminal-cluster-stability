...
class MyWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Bottom section (File browsers)
        bottom_section = QVBoxLayout()

        # Labels, inputs, and buttons for file browsers
        self.file_browsers = [
            {'label': 'FASTA Data File B1:', 'input': QLineEdit(), 'button': QPushButton('Browse for B1 data')},
            {'label': 'FASTA Data File B2:', 'input': QLineEdit(), 'button': QPushButton('Browse for B2 data')},
            {'label': 'FASTA Data File B3:', 'input': QLineEdit(), 'button': QPushButton('Browse for B3 data')},
            {'label': 'FASTA Data File B4:', 'input': QLineEdit(), 'button': QPushButton('Browse for B4 data')}
        ]
